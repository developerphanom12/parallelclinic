...
// import flower1 from "../assets/flower1.jpeg"; // Replace with your actual image
 ...
 const menuItems = [
  ...
  return (
    <div className="relative w-full  bg-[#FDF8E5] overflow-hidden h-[100vh]">
      ...
      />
      {/* Navbar */}
      <nav className="w-full flex justify-between items-start px-8 sm:py-4">
        <div className="flex flex-col sm:pl-16 sm:w-[40%]">
          {/* Heading */}
          <div style={{ fontFamily: "MyFont" }} className="mt-18 text-[#A37159] leading-0">
